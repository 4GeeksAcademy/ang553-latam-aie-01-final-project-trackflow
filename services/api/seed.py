"""Seeder for TrackFlow supplier directory."""
...
def main() -> None:
    existing_names = {doc.get("name") for doc in suppliers.all() if "name" in doc}
    inserted = 0
    skipped = 0
    ...
    for raw_supplier in SUPPLIERS_SEED:
        ...
        supplier_model = SupplierCreate.model_validate(raw_supplier)
