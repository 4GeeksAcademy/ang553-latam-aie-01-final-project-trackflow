/**
 * Content component for the Outbound Stock Exit page.
 *
 ...
 * ``<OutboundStockForm />`` which handles validation and real POST
...
import { OutboundStockForm } from "@/components/inventory/OutboundStockForm";
import {
  ApiError,
...
export function OutboundStockPageContent() {
